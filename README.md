...
6) The PDF of the documentation generated by Doxygen. A link to the download of a zip file containing a copy of this PDF as well as the resources to view the HTML version of the documentation is available in the readme below.
